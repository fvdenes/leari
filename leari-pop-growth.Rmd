...
\
Abundance ("site"-level) covariates: month (numeric: 6-11)  and year (numeric: 2004-2014)  
\
Year as linear, 2nd and 3rd order polynomials
...
site.covs <- data.frame(year=sites[[1]]-2000,year2=(sites[[1]]-2000)^2,year3=(sites[[1]]-2000)^3 ,month=sites[[2]])
...
flist <- fitList(timesNull=m02,timesyear=m06,timesyear2=m10,timesyear3=m14)
modSel(flist) 
```
Best model includes 'year' as a 2nd order polynomial for abundance  
\
...
pb <- parboot(m10, nsim=100, report=1)
```
